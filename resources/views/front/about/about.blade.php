            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    <div class="about-img mb-55">
                        <img src="{{ asset('/assets/front/img/about/about_details_left_img.jpg') }}" alt="">
                    </div>
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about-img mb-55">
                        <img src="{{ asset('/assets/front/img/about/about_details_right_img.jpg') }}" alt="">
                    </div>
                    <div class="about-title-section about-title-section-2 mb-30">
            ...
            <div class="row mt-60">
                <div class="col-xl-12">
                    <div class="university-banner mb-30">
                        <img src="{{ asset('/assets/front/img/about/university.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="team-list">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{ asset('/assets/front/img/team/teammember1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{ asset('/assets/front/img/team/teammember2.jpg') }}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{ asset('/assets/front/img/team/teammember3.jpg') }}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{ asset('/assets/front/img/team/teammember4.jpg') }}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
                ...
                <div class="row testimonilas-active">
                    ...
                    <div class="col-xl-12">
                        <div class="testimonilas-wrapper">
                            <div class="testimonilas-heading d-flex">
                                <div class="testimonilas-author-thumb">
                                    <img src="{{ asset('/assets/front/img/testimonials/testimonilas_author_thumb2.png') }}" alt="">
                                </div>
                                <div class="testimonilas-author-title">
